  ...
  head(): MetaInfo {
    ...
    return {
      ...
      link: [
        {
          rel: 'canonical',
          href: `https://covid19-akita.netlify.com/p${this.$route.path}`
        },
        {
          rel: 'stylesheet',
      ...
      meta: [
        ...
        },
        {
          ...
          name: 'description',
          content: this.$tc(
            '当サイトは新型コロナウイルス感染症 (COVID-19) に関する最新情報を提供するために、東京都が開設したものを、秋田県向けにしたものです。'
          )
        },
        {
          hid: 'og:site_name',
        ...
        },
        {
          hid: 'og:url',
          property: 'og:url',
          content: `https://covid19-akita.netlify.com/${this.$route.path}`
        },
        ogLocale,
        {
          hid: 'og:title',
